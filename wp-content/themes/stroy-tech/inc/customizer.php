 ...
 */
function Stroytech_customize_register($wp_customize)
{
    /*
     * -----------------------------------------------------
     * Live Preview для названия и описания сайта
    ...
    if (isset($wp_customize->selective_refresh)) {
        ...
        $wp_customize->selective_refresh->add_partial('blogname', [
            ...
            'render_callback' => 'Stroytech_customize_partial_blogname',
        ]);

        $wp_customize->selective_refresh->add_partial('blogdescription', [
            'selector'        => '.site-description',
            'render_callback' => 'Stroytech_customize_partial_blogdescription',
        ]);
    }
    ...
    $wp_customize->add_section('Stroytech_containers', [
        'title'    => 'Контейнеры',
        'priority' => 30,
    ]);
    ...
    $wp_customize->add_setting('container_width_unit', [
        'default'           => 'px',
        'sanitize_callback' => 'Stroytech_sanitize_container_unit',
        'transport'         => 'refresh',
    ]);
...
add_action('customize_register', 'Stroytech_customize_register');
 ...
 * @return string
 */
function Stroytech_sanitize_container_unit($value)
{
 ...
 */
function Stroytech_customize_partial_blogname()
{
    bloginfo('name');
}
 ...
 */
function Stroytech_customize_partial_blogdescription()
{
 ...
 * --theme-color-green
 */
function Stroytech_customize_colors_register($wp_customize)
{
    /*
     * Цвета по умолчанию.
     */
...
add_action('customize_register', 'Stroytech_customize_colors_register');
 ...
 * @return array
 */
function Stroytech_get_theme_settings()
{
    return [
        ...
        'container_width_unit' => Stroytech_sanitize_container_unit(
            get_theme_mod(
        ...
        'fixed_container_width_unit' => Stroytech_sanitize_container_unit(
            get_theme_mod(
 ...
 */
function Stroytech_output_custom_properties()
{
    $settings = Stroytech_get_theme_settings();
    ...
    echo '<style id="Stroytech-theme-custom-properties">
...
add_action('wp_head', 'Stroytech_output_custom_properties');
 ...
 */
function Stroytech_editor_custom_properties()
{
    $settings = Stroytech_get_theme_settings();
...
add_action(
    ...
    'Stroytech_editor_custom_properties'
);
