...
Kirki::add_field('e_shop_settings', array(
	...
	'description'		 => sprintf(__('The demo homepage is enabled. You can choose from some predefined layouts or make your own %s.', 'e-shop'), '<a href="' . admin_url('themes.php?page=eshop-welcome') . '"><strong>' . __('custom homepage template', 'e-shop') . '</strong></a>'),
	'section'			 => 'e_shop_woo_demo_section',
	'default'			 => 'style-one',
	'priority'			 => 10,
	'choices'			 => array(
...
Kirki::add_field('e_shop_settings', array(
	...
	'section'		 => 'e_shop_woo_demo_section',
	'description'	 => '<a href="' . esc_url('http://themes4wp.com/product/eshop-pro/') . '" target="_blank" class="button button-primary">' . sprintf(esc_html__('Learn more about %s PRO', 'e-shop'), 'eshop') . '</a>',
	'priority'		 => 10,
));
